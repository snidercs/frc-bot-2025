...
private:
    ...
    static constexpr units::turn_t kFrontLeftEncoderOffset = -0.021240234375_tr;
    static constexpr bool kFrontLeftSteerMotorInverted     = false;
    static constexpr bool kFrontLeftEncoderInverted        = false;

    static constexpr units::inch_t kFrontLeftXPos = 13.75_in;
    static constexpr units::inch_t kFrontLeftYPos = 13.75_in;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = -0.43896484375_tr;
    static constexpr bool kFrontRightSteerMotorInverted     = false;
    static constexpr bool kFrontRightEncoderInverted        = false;

    static constexpr units::inch_t kFrontRightXPos = 13.75_in;
    static constexpr units::inch_t kFrontRightYPos = -13.75_in;

    // Back Left
    static constexpr int kBackLeftDriveMotorId            = 9;
    static constexpr int kBackLeftSteerMotorId            = 3;
    static constexpr int kBackLeftEncoderId               = 11;
    static constexpr units::turn_t kBackLeftEncoderOffset = -0.017822265625_tr;
    static constexpr bool kBackLeftSteerMotorInverted     = false;
    static constexpr bool kBackLeftEncoderInverted        = false;

    static constexpr units::inch_t kBackLeftXPos = -13.75_in;
    static constexpr units::inch_t kBackLeftYPos = 13.75_in;
    ...
    static constexpr units::turn_t kBackRightEncoderOffset = 0.01123046875_tr;
    static constexpr bool kBackRightSteerMotorInverted     = false;
    static constexpr bool kBackRightEncoderInverted        = false;

    static constexpr units::inch_t kBackRightXPos = -13.75_in;
    static constexpr units::inch_t kBackRightYPos = -13.75_in;
...
public:
   ...
   */
    ...
    TunerSwerveDrivetrain (
        ...
        ModuleConstants const&... modules)
        : SwerveDrivetrain { driveTrainConstants, odometryUpdateFrequency, odometryStandardDeviation, visionStandardDeviation, modules... } {}
};
